...
You can read the [old post]({{site.baseurl}}{% link _posts/2019-08-24-music-generation-fail.md %}) for a bit of self-deprecation.
...
<hr>
This first song goes nicely for the first 2 minutes or so
<audio controls="controls" 
	src="{{site.baseurl}}/assets/ai-music/mid1.mp3" 
	type="audio/mp3">
...
<audio controls="controls" 
        src="{{site.baseurl}}/assets/ai-music/mid2.mp3" 
        type="audio/mp3">
Your browser does not support the audio element.
</audio>

<hr>
Again this begins with a repeated G# reminiscent of the raindrop prelude, it's overfitting a bit to a few songs in the first minute and a half or so
<audio controls="controls" 
        src="{{site.baseurl}}/assets/ai-music/mid3.mp3" 
        type="audio/mp3">
Your browser does not support the audio element.
</audio>
<hr>
